...
export const depositMethodAction = (depositOption) => async (dispatch) => {
  ...
  try {
    ...
    axios
      .post(
        "https://api.utopiansglobal.com/deposit/admin/options",
        depositOption,
        config
      )
      .then((response) => {
...
export const updateDepositMethodHistory =
  (depositMethodInfo) => async (dispatch) => {
    ...
    try {
      ...
      fetch(
        `https://api.utopiansglobal.com/deposit/admin/options/${depositMethodInfo.id}`,
        {
          method: "PUT",
          headers: {
            "content-type": "application/json",
...
export const deleteDepositMethodHistory = (id) => async (dispatch) => {
  ...
  try {
    ...
    fetch(`https://api.utopiansglobal.com/deposit/admin/options/${id}`, {
      method: "DELETE",
      headers: {
        "content-type": "application/json",
        authorization: `Bearer ${token}`,

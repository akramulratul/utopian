...
export const addDeposite = (addDepositeData) => async (dispatch) => {
    ...
    try {
        ...
        axios.post('https://utopain-backend.herokuapp.com/user/balance/deposits', addDepositeData, config)
            .then(response => {
                dispatch({
...
export const getDepositeHistory = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get('https://utopain-backend.herokuapp.com/user/balance/deposits', config)
        dispatch({

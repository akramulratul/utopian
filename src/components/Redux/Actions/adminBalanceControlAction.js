...
export const getAdminDepositeHistory = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(
      "https://api.utopiansglobal.com/admin/balance/deposits",
      config
    );
    dispatch({
...
export const adminDepositeManageAction = (depositData) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      `https://api.utopiansglobal.com/admin/balance/deposits/${depositData.id}/manage`,
      statusData,
      config
    );
    console.log(data);
...
export const getAdminWithdrawHistory = () => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(
      "https://api.utopiansglobal.com/admin/balance/withdraws",
      config
    );
    dispatch({
...
export const adminWithdrawManageAction = (withdrawData) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      `https://api.utopiansglobal.com/admin/balance/withdraws/${withdrawData.id}/manage`,

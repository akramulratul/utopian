...
export const forgetPasswordByPhoneNumber = (forgetData, history) => async (dispatch) => {
        ...
        fetch("https://utopain-backend.herokuapp.com/auth/forgetPass/generateOtp", {
            ...
            .then((data) => {
                ...
                if (data.statusCode == 201) {
                    ...
                    setTimeout(function () { history.push('/verify-otp') }, 2000);
                } else {
...
export const forgetPasswordByVerifyOtp = (forgetData, history) => async (dispatch) => {
        ...
        fetch("https://utopain-backend.herokuapp.com/auth/forgetPass/verifyOTP", {
            ...
            .then((data) => {
                ...
                if (data.statusCode == 200) {
                    ...
                    // history.push('/confirm-password')
                    setTimeout(function () { history.push('/confirm-password') }, 2000);
                } else {
                    toast.error(`${data.message}`, {
                        position: "top-right",
                        autoClose: 2000,
...
export const confirmPasswordAction = (confirmDataInfo, history) => async (dispatch) => {

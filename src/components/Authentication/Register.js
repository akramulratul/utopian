                    ...
                    <div className="">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="password-box">
                                ...
                                />
                                {
                                    iconHide2 ? showConfirmPassword ? <FontAwesomeIcon icon={faEye} onClick={showConfirmPasswordHandle} /> : <FontAwesomeIcon icon={faEyeSlash} onClick={showConfirmPasswordHandle} /> : ""

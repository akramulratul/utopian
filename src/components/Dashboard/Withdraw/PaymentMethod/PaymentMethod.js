                    ...
                    <div>
                        ...
                        <div className="row d-flex justify-content-between p-5">
                            <div className="col-lg-6 col-12">
                                ...
                                <h6>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero, nesciunt? </h6>
                            ...
                            <div className="col-lg-6 col-12 p-5">
                                {
                                    value !=="" ? <h1>hello</h1> :<div>
                                    <img className="rounded mx-auto d-block"src={security} alt=""/>
                                    <h3 className="text-center">Payment method will be available after selecting country</h3>
                                </div>
                                }
                            </div>
                        </div>

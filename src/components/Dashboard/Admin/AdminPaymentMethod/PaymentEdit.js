...
import { updateDepositMethodHistory } from "../../../Redux/Actions/adminDepositMethodAction";
...
const PaymentEdit = () => {
    ...
    const onSubmit = (data, e) => {
        ...
        if (data.agentNumber.length === 11) {
            dispatch(updateDepositMethodHistory(depositOption))
        } else {
            ...
            <div className="Form">
                ...
                <div>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <button className="pt-2 btn btn-brand w-100 py-2 mt-4" type="submit">Update</button>
                    </form>
                </div>
            </div>
            <ToastContainer />

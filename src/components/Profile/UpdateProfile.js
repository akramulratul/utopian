            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="name-row row">
                    <div className="col-lg-6">
                        ...
                        {errors.firstName && <span className='text-danger'>*</span>}<br />
                    </div>
                ...
                <div className="email-phone row">
                    <div className="col-lg-6">
                        ...
                        {errors.email && <span className='text-danger'>*</span>}<br />
                    </div>

                    <div className="col-lg-6">
                        <label htmlFor="phone">Phone</label>
                        <input className='form-control' {...register("phone", { required: true })} />
                        {errors.phone && <span className='text-danger'>*</span>}<br />
                    </div>
                </div>
                <div className="about">
                    <label htmlFor="about">About</label>
                    <textarea className='form-control' cols='100' defaultValue="" {...register("about")} />
                </div>
                <div className="address">
                    <label htmlFor="address">Address</label>
                    <textarea className='form-control' cols='100' defaultValue="" {...register("address")} />
                </div>
                ...
                <button className='btn-brand border-0 py-2 px-5 mt-3' type='submit'>Save Changes</button>
            </form>
        </div>
    );
};

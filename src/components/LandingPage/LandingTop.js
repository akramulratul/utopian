           ...
           <div className='page-container d-flex align-items-center align-items-center'>
               ...
               <div className="col-lg-5 text-left d-flex align-items-center">
                    <div className="text-white p-5">
                        <h1> <b> Complicated life turns into a simpler profit here.</b></h1>
                        <p className='text-white py-4'>Join us for innovative profit already millions are trade and earn a smartest income. You can too.</p>
